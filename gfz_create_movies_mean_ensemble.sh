...
LD_PRELOAD=''
/usr/bin/mencoder mf://frames_movie_mean_ensemble/Forecast_E_1_MeV_PA_50*.png -mf w=1920:h=1080:fps=30:type=png -x264encopts bitrate=2000 -ovc x264 -oac copy -of lavf -o Forecast_UTC_E_1_MeV_PA_50_latest_mean_ensemble.mp4
#source $FC_HOME/setup_forecast_output.sh

# create short movie 20 seconds
/usr/bin/ffmpeg -i Forecast_UTC_E_1_MeV_PA_50_latest_mean_ensemble.mp4 -r 16 -filter:v "setpts=0.32*PTS"  Forecast_UTC_E_1_MeV_PA_50_latest_mean_ensemble_short.mp4
