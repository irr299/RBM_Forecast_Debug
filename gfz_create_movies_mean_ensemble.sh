...
/usr/bin/ffmpeg -y -framerate 30 -f concat -safe 0 -i "$FRAME_LIST_FILE" -vf "scale=1920:1080:flags=lanczos" -c:v libx264 -preset medium -crf 23 -pix_fmt yuv420p -movflags +faststart -bf 0 Forecast_UTC_E_1_MeV_PA_50_latest_mean_ensemble.mp4
