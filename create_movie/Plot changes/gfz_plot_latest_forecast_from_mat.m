...
output_latest_file=[getenv('FC_LATEST') 'Forecast_' name_part '_UTC_latest.png'];
output_date_file=[getenv('FC_PNG_FORECAST') sprintf('Forecast_%s_UTC_%s.png',name_part,datestr(forecast_data.utc,'YYYYmmddTHHMMSS'))];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
forecast_data.timesd = reshape(forecast_data.timesd,[],1);
