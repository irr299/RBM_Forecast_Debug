...
latest_mat_file_info=dir([getenv('FC_LATEST') 'ENSEMBLES/' 'Forecast_mean_ensemble_' name_part '_UTC_latest.mat']);
...
output_latest_file=[getenv('FC_LATEST') 'Forecast_mean_ensemble_' name_part '_UTC_latest_interpsat.png'];
